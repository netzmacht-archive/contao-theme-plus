...
use ThemePlus\Twig\CompileJsTokenParser;
...
class TwigExtension
{
	public function init(\ContaoTwig $twig)
	{
		$twig->getEnvironment()->addFilter(
			'compileJs',
			new \Twig_Filter_Function('ThemePlus\TwigExtension::compileJs')
		);
		$twig->getEnvironment()->addFilter(
			'compileCss',
			new \Twig_Filter_Function('ThemePlus\TwigExtension::compileCss')
		);
