...
(
    ...
    'exclude'                 => true,
    'inputType'               => 'checkbox',
    'options_callback'        => array('Bit3\Contao\ThemePlus\DataContainer\Layout', 'getStylesheets'),
...
(
    ...
    'exclude'                 => true,
    'inputType'               => 'checkbox',
    'options_callback'        => array('Bit3\Contao\ThemePlus\DataContainer\Layout', 'getJavaScripts'),
    'eval'                    => array('multiple'=> true,
                                       'tl_class'=> 'clr'),
    'sql'                     => 'blob NULL',
);
